              ...
              <div class="box-body">
                <div class="form form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <div class="input-group col-md-12 col-sm-8 col-xs-12">
                        <select class="form-control select2 required" name="id_surat" id="id_surat" style="width:100%;">
                          ...
                          <?php foreach ($menu_surat_mandiri as $data) : ?>
                            <option value="<?= $data['id'] ?>" <?php selected($data['id'], $permohonan['id_surat']) ?>>
                              <?= $data['nama'] ?>
                            </option>
                          <?php endforeach; ?>
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <div class="input-group col-md-12 col-sm-8 col-xs-12">
                        <input class="form-control input-lg bilangan_spasi required <?= jecho($cek_anjungan, TRUE, 'kbvnumber'); ?>" type="text" name="no_hp_aktif" id="no_hp_aktif" placeholder="Tulis nomor telepon" maxlength="14" value="<?= $permohonan['no_hp_aktif']; ?>" />
                      </div>
                    </div>
                  </div>
                </div>
