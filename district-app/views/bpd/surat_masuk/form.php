	...
	<section class="content" id="maincontent">
		<div class="box box-info">
			<div class="box-header with-border">
				<a href="<?= site_url("bpd_surat_masuk")?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Wilayah">
			...
			<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal nomor-urut">
				<div class="box-body">
					...
					<input type="hidden" id="url_remote" name="url_remote" value="<?= site_url('bpd_surat_masuk/nomor_surat_duplikat')?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="mailbox-attachment-info">
									<a href="<?= site_url("/bpd_surat_masuk/unduh_berkas_scan/$surat_masuk[id]");?>" title=""><i class="fa fa-paperclip"></i> <?= $surat_masuk['berkas_scan'];?></a>
