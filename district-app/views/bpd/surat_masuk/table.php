...
<div class="content-wrapper">
	<section class="content-header">
		<h1>BPD - Buku Surat Masuk</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">BPD - Buku Surat Masuk</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<div class="box box-info">
			<div class="box-header with-border">
				<a href="<?= site_url('bpd_surat_masuk/form') ?>" title="Tambah Surat Masuk Baru" class="btn btn-social btn-box bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus"></i> Tambah Surat Masuk Baru</a>
														...
														<tr>
															...
															<td class="nostretch">
																<div class="btn-group-vertical">
																	<a class="btn btn-social btn-box btn-success btn-sm" data-toggle="dropdown">Aksi <i class='fa fa-arrow-circle-down'></i> </a>
																	<ul class="dropdown-menu" role="menu">
																		<li>
																			<a href="<?= site_url("bpd_surat_masuk/form/$p/$o/$data[id]") ?>" class="btn btn-social btn-box btn-block btn-sm" title="Ubah Data"><i class="fa fa-edit"></i> Ubah</a>
																		</li>
																		<li>
																			<?php if ($data['berkas_scan']): ?>
																				<a href="<?= base_url(LOKASI_ARSIP . $data['berkas_scan']) ?>" class="btn btn-social btn-box btn-block btn-sm" title="Unduh Berkas Surat" target="_blank"><i class="fa fa-download"></i> Unduh berkas surat</a>
																			<?php endif; ?>
																		</li>
																		<li>
																			<a href="<?= site_url("bpd_surat_masuk/dialog_disposisi/$o/$data[id]") ?>" class="btn btn-social btn-box btn-block btn-sm" title="Cetak Lembar Disposisi Surat" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Lembar Disposisi Surat"><i class="fa fa-file-archive-o"></i> Cetak Disposisi</a>
																		</li>
																		<li>
																			<a href="#" data-href="<?= site_url("bpd_surat_masuk/delete/$p/$o/$data[id]") ?>" class="btn btn-social btn-box btn-block btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i> Hapus</a>
																		</li>
																	</ul>
																</div>
															</td>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="dataTables_length">
										<form id="paging" action="<?= site_url("bpd_surat_masuk") ?>" method="post" class="form-horizontal">
											<label>
												Tampilkan
									...
									<div class="dataTables_paginate paging_simple_numbers">
										<ul class="pagination">
											<?php if ($paging->start_link): ?>
												<li><a href="<?= site_url("bpd_surat_masuk/index/$paging->start_link/$o") ?>" aria-label="First"><span aria-hidden="true">Awal</span></a></li>
											<?php endif; ?>
											<?php if ($paging->prev): ?>
												<li><a href="<?= site_url("bpd_surat_masuk/index/$paging->prev/$o") ?>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
											<?php endif; ?>
											<?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++): ?>
												<li <?= jecho($p, $i, "class='active'") ?>><a href="<?= site_url("bpd_surat_masuk/index/$i/$o") ?>"><?= $i ?></a></li>
											<?php endfor; ?>
											<?php if ($paging->next): ?>
												<li><a href="<?= site_url("bpd_surat_masuk/index/$paging->next/$o") ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
											<?php endif; ?>
											<?php if ($paging->end_link): ?>
												<li><a href="<?= site_url("bpd_surat_masuk/index/$paging->end_link/$o") ?>" aria-label="Last"><span aria-hidden="true">Akhir</span></a></li>
											<?php endif; ?>
										</ul>
									</div>
								</div>
