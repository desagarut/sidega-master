...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('bpd_ekspedisi')?>"> Buku Ekspedisi</a></li>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url("bpd_ekspedisi")?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Kembali Ke Buku Ekspedisi">
					...
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal nomor-urut">
						<div class="box-body">
							...
							<input type="hidden" id="url_remote" name="url_remote" value="<?= site_url('bpd_surat_keluar/nomor_surat_duplikat')?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="mailbox-attachment-info">
											<a href="<?= site_url('/bpd_surat_keluar/unduh_berkas_scan/'.$surat_keluar['id']);?>" title=""><i class="fa fa-paperclip"></i> <?= $surat_keluar['tanda_terima'];?></a>
