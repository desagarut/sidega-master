...
<div class="content-wrapper">
	<section class="content-header">
		<h1>BPD - Buku Ekspedisi</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">BPD - Buku Ekspedisi</li>
		</ol>
	</section>
														...
														<tr>
															...
															<td class="nostretch">
																...
																<?php if ($data['tanda_terima']): ?>
																	<a href='<?= site_url("{$this->controller}/unduh_tanda_terima/$data[id]") ?>' class="btn bg-purple btn-box btn-sm" title="Unduh Tanda Terima" target="_blank"><i class="fa fa-download"></i></a>
																<?php endif; ?>
																<a href="<?= site_url("{$this->controller}/bukan_ekspedisi/$p/$o/$data[id]") ?>" class="btn bg-olive btn-box btn-sm" title="Keluarkan dari Buku Ekspedisi"><i class="fa fa-undo"></i></a>
															</td>
