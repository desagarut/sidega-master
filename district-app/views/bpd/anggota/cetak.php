...
<head>
	<title>BUKU DATA ANGGOTA BPD</title>
...
<body>
	<div id="container">
		...
		<div id="body">
			<div align="center">
				<h3> BUKU DATA ANGGOTA BPD <?= strtoupper($this->setting->sebutan_desa) ?> <?= strtoupper($desa['nama_desa']) ?> </h3>
			</div>
			<table>
			...
			<?php include("district-app/views/bpd/blok_ttd_bpd.php"); ?>
		</div>
	</div>
</body>
