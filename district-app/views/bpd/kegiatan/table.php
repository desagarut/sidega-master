														...
														<table class="table table-bordered table-striped dataTable table-hover">
															<thead class="bg-gray disabled color-palette">
																<tr>
																	...
																	<th>Gambar</th>
																	<?php if ($o == 2) : ?>
																		<th><a href="<?= site_url("gallery/index/$p/1") ?>">Jenis Kegiatan <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 1) : ?>
																		<th><a href="<?= site_url("gallery/index/$p/2") ?>">Jenis Kegiatan <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th><a href="<?= site_url("gallery/index/$p/1") ?>">Jenis Kegiatan <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th>Pelaksana</th>
