...
<div class="form-group">
	<label for="keperluan" class="col-sm-3 control-label">Nama Ayah - Ibu</label>
	<div class="col-sm-4">
		<input class="form-control input-sm" type="text" value="<?= $individu['nama_ayah'] ?>" disabled="">
	</div>
	<div class="col-sm-4">
		<input class="form-control input-sm" type="text" value="<?= $individu['nama_ibu'] ?>" disabled="">
	</div>
</div>