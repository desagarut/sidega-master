...
<div class="form-group">
	<label for="hp_ortu" class="col-sm-3 control-label">No HP - Email</label>
	<div class="col-sm-4">
...
<div class="form-group">
	<label class="col-sm-3 control-label" for="wajib_pantau">Apakah Bumil Wajib Dipantau?</label>
	<div class="col-sm-2">
	...
	<div class="col-sm-5">
		<span id="wajib_pantau_plus_msg" class="help-block">
			<code>Jika ya, Data Bumil akan masuk dalam daftar Pemantauan Bumil.</code>
		</span>
	</div>
</div>
