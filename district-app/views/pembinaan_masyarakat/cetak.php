				...
				<tbody>
					...
					<tr>
						<td style="padding: 5px 20px;">
							...
							<strong>Penyelenggara : </strong><?= $sasaran[$peserta[0]["penyelenggara"]];?><br>
							<strong>Waktu Kegiatan : </strong><?= fTampilTgl($peserta[0]["sdate"],$peserta[0]["edate"]);?><br>
							<strong>Lokasi : </strong><?= $sasaran[$peserta[0]["lokasi"]];?><br>
							<strong>Anggaran : </strong><?= $sasaran[$peserta[0]["anggaran"]];?><br>
							<strong>Sumber Dana : </strong><?= $sasaran[$peserta[0]["sumber_dana"]];?><br>
