													...
													<tbody>
														...
														<?php foreach ($program as $item): ?>
															...
															<tr>
																...
																<?php if ($this->CI->cek_hak_akses('h')): ?>
                                                                <td nowrap>
																	<a href="<?= site_url("pembinaan_masyarakat/detail/$item[id]")?>" class="btn bg-purple btn-box btn-sm" title="Rincian"><i class="fa fa-list"></i></a>
																	<a href="<?= site_url("pembinaan_masyarakat/edit/$item[id]")?>" class="btn bg-orange btn-box btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
																	<?php if ($item['jml_peserta'] != 0): ?>
																		<a href="<?= site_url("pembinaan_masyarakat/expor/$item[id]"); ?>" class="btn bg-navy btn-box btn-sm" title="Expor"><i class="fa fa-download"></i></a>
																	...
																	<?php endif ?>
																	<?php if ($item['jml_peserta'] == 0): ?>
																		<a href="#" data-href="<?= site_url("pembinaan_masyarakat/hapus/$item[id]")?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																	<?php endif ?>
																</td>
                                                                <?php endif;?>
