										...
										<div class="row">
											<div class="col-sm-6">
												<div class="box box-info box-solid">
													...
													<div class="box-body">
														<?php include('district-app/views/pembinaan_masyarakat/konfirmasi_peserta.php'); ?>
													</div>
												</div>
											</div>
										</form>
											...
											<div class="box box-success box-solid">
												...
												<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
													<div class="box-body">
														...
														<div class="form-group">
															<label for="no_id_kartu" class="col-sm-4 col-lg-4 control-label">Nomor Kartu/Sertifikat</label>
															<div class="col-sm-8">
																<input id="no_id_kartu" class="form-control input-sm nama_terbatas" type="text" placeholder="Nomor Kartu Peserta" name="no_id_kartu" maxlength="30">
															</div>
														</div>
														<div class="form-group">
															<label for="jenis_keramaian" class="col-sm-4 col-lg-4 control-label">Foto Kartu/sertifikat</label>
															<div class="col-sm-8">
