...
<table>
	<tbody>
		...
		<tr>
			<td style="padding: 5px 20px;">
				<strong>Nama Lembaga : </strong><?= $lembaga['nama']; ?><br>
				<strong>Ketua Lembaga : </strong><?= $lembaga['nama_ketua']; ?><br>
				<strong>Kategori Lembaga : </strong><?= $lembaga['kategori']; ?><br>
				<strong>Keterangan : </strong><?= $lembaga['keterangan'];?>
			</td>
		</tr>
		<tr>
			<td style="padding: 5px 20px;">
