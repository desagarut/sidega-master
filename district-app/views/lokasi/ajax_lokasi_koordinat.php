						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<?php switch ($edit): ?><?php
																case '0': ?>
									<input readonly="readonly" class="form-control number" name="lat1" id="lat1" value="<?= $lokasi['lat'] ?>" />
									<?php break; ?>
								<?php
																case '1': ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<?php switch ($edit): ?><?php
																case '0': ?>
									<input readonly="readonly" class="form-control number" name="lng1" id="lng1" value="<?= $lokasi['lng']; ?>" />
									<?php break; ?>
								<?php
																case '1': ?>
