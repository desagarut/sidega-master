				...
				<div class="col-md-12">
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="url"><?php if ($modul['parent'] != '0') : ?>Nama Sub Url<?php else : ?>Nama Url<?php endif ?></label>
								<div class="col-sm-6">
									<input type="hidden" name="url" value="1">
									<input type="hidden" name="parent" value="<?= ($modul['parent']) ?>">
									<input id="url" name="url" class="form-control input-sm required" type="text" placeholder="Nama Url/Sub Url" value="<?= ($modul['url']) ?>" maxlength="30"></input>
								</div>
							</div>
							<div class="form-group">
