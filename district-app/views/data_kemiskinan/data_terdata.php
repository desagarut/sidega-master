...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url("data_kemiskinan/rincian/$data_kemiskinan[id]"); ?>"></i> Rincian Data Kemiskinan</a></li>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url("data_kemiskinan/rincian/$data_kemiskinan[id]"); ?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Rincian Kategori</a>
					</div>
					<div class="box-body ">
						...
						<div class="row">
							...
							<div class="col-md-9">
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-hover tabel-rincian">
										<tbody>
											<?php $judul = ($data_kemiskinan['sasaran'] == 1) ? 'Penduduk' : 'KK' ?>
											<tr>
												<td width="20%"><?= ($data_kemiskinan["sasaran"] == 1) ? 'NIK / Nama Penduduk' : 'No. KK / Nama KK'; ?></td>
												<td width="1%">:</td>
