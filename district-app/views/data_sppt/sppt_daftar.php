                                          ...
                                          <td align="center">
                                            <div class="btn-group">
                                              ...
                                              <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a href="<?= site_url("data_sppt/form_tagih/edit/" . $item["id_sppt"]) ?>" class="btn btn-social bg-green btn-box btn-block btn-sm" title="Buat Tagihan Pajak" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Buat Tagihan Pajak"><i class="fa fa-dollar"></i> Buat Tagihan</a> </li>
