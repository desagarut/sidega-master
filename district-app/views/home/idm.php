<?php  if ($halaman_statis): ?>
	...
	<?php endif; ?>
	<?php if (is_file("i/themes/".$this->theme.'/assets/css/instansi-web.css')): ?>
		<link type='text/css' href="<?= base_url().$this->theme_folder.'/'.$this->theme.'/assets/css/instansi-web.css' ?>" rel='stylesheet' />
	<?php endif; ?>
	<?php if (is_file("instansi/css/".$this->theme."/instansi-web.css")): ?>
		<link type='text/css' href="<?= base_url()?>instansi/css/<?= $this->theme ?>/instansi-web.css" rel='Stylesheet' />
	<?php endif; ?>
<?php endif; ?>
