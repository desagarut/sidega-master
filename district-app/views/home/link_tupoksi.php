<div class="box box-success box-solid">
    <div class="box-body">
        <div class="row text-center" style="padding-top:20px">
            ...
            <a class="btn btn-app" href="<?php if ($this->CI->cek_hak_akses('h')) : ?><?= site_url('pemas') ?><?php endif; ?>" title="Pemberdayaan Masyarakat"><span class="badge bg-aqua"></span><i class="fa fa-hand-rock-o text-blue"></i> Pemberdayaan</a><br/>
