<footer class="main-footer">
	<span class="logo-mini logo-text" style="padding-top:7px"><img src="<?php echo base_url() . 'assets/files/logo/sidega.png'; ?>" class="img-circle logo-desa" alt="User Image" width="30px"></span> <a href="https://desagarut.id" target="_blank"><b>SIDeGa Versi <?= AmbilVersi() ?></b> - </a> Inspirasi untuk desa & kelurahan di <strong><a href="https://garutkab.go.id" target="_blank">Kabupaten Garut</a></a>.</strong>
</footer>
