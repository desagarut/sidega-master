														...
														<table class="table table-bordered table-striped dataTable table-hover">
															<thead class="bg-gray disabled color-palette">
																<tr>
																	...
																	<th>Video Depan</th>
																	<?php if ($o == 2) : ?>
																		<th><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/1") ?>">Nama Gambar <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 1) : ?>
																		<th><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/2") ?>">Nama Gambar <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/1") ?>">Nama Gambar <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th width=20%>Deskripsi</th>
																	<?php if ($o == 4) : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/3") ?>">Aktif <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 3) : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/4") ?>">Aktif <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/3") ?>">Aktif <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<?php if ($o == 6) : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/5") ?>">Dimuat Pada <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 5) : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/6") ?>">Dimuat Pada <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th nowrap><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$p/5") ?>">Dimuat Pada <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th>Aksi</th>
																</tr>
															</thead>
																...
																<?php foreach ($sub_gallery as $data) : ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="<?= site_url("gallery_cctv/form_sub_gallery/$gallery/$data[id]") ?>" class="btn btn-warning btn-box btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
																			<?php if ($this->CI->cek_hak_akses('h')) : ?>
																				...
																				<?php endif ?>
																				<a href="#" data-href="<?= site_url("gallery_cctv/delete_sub_gallery/$gallery/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																			<?php endif; ?>
																		</td>
																	</tr>
																<?php endforeach; ?>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="dataTables_length">
													<form id="paging" action="<?= site_url("gallery_cctv/sub_gallery/$gallery") ?>" method="post" class="form-horizontal">
														<label>
															Tampilkan
												...
												<div class="dataTables_paginate paging_simple_numbers">
													<ul class="pagination">
														<?php if ($paging->start_link) : ?>
															<li><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$paging->start_link/$o") ?>" aria-label="First"><span aria-hidden="true">Awal</span></a></li>
														<?php endif; ?>
														<?php if ($paging->prev) : ?>
															<li><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$paging->prev/$o") ?>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
														<?php endif; ?>
														<?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
															<li <?= jecho($p, $i, "class='active'") ?>><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$i/$o") ?>"><?= $i ?></a></li>
														<?php endfor; ?>
														<?php if ($paging->next) : ?>
															<li><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$paging->next/$o") ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
														<?php endif; ?>
														<?php if ($paging->end_link) : ?>
															<li><a href="<?= site_url("gallery_cctv/sub_gallery/$gallery/$paging->end_link/$o") ?>" aria-label="Last"><span aria-hidden="true">Akhir</span></a></li>
														<?php endif; ?>
													</ul>
												</div>
											</div>
