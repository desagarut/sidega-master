																...
																<?php foreach ($main as $data) : ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="<?= site_url("area/ajax_area_maps/$p/$o/$data[id]") ?>" class="btn bg-olive btn-box btn-sm" title="Lokasi <?= $data['nama'] ?>"><i class="fa fa-google"></i></a>
																			<a href="<?= site_url("area/ajax_area_maps_osm/$p/$o/$data[id]") ?>" class="btn bg-olive btn-box btn-sm" title="Lokasi <?= $data['nama'] ?>"><i class="fa fa-map"></i></a>																			<?php if ($data['enabled'] == '2') : ?>
