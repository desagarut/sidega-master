														...
														<div class="row">
															<div class="col-sm-12">
																<form action="<?= $form_action?>" method="post" enctype="multipart/form-data" id="excell" class="form-horizontal">
																	...
																	<ul>
																		<li> <a href="https://github.com/SIDeGa/SIDeGa/issues">https://github.com/SIDeGa/SIDeGa/issues</a></li>
																		<li> <a href="https://www.facebook.com/groups/SIDeGa/">https://www.facebook.com/groups/SIDeGa/</a></li>
																	</ul>
