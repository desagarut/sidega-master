		...
		<div class="col-sm-12">
			...
			<div class="form-group">
				...
				<div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
					<label id="sx3" class="btn btn-info btn-box btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label <?php ($main['enabled'] =='1') and print('active') ?>">
					...
					<label id="sx4" class="btn btn-info btn-box btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label <?php ($main['enabled'] =='2') and print('active') ?>">
