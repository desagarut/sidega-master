<?php class Bpd_ekspedisi_model extends Bpd_surat_keluar_model {
	...
	/**
	 * Update data di tabel bpd_tbl_surat_keluar untuk ekspedisi
	 * @param   integer  $id  Id bpd_tbl_surat_keluar untuk query ke database
	 * @return  void
	 */
	public function update($id)
	{
		...
		if ($ada_berkas === TRUE)
		{
			...
			if ($this->upload->do_upload('tanda_terima'))
			{
				...
				$this->db->where('id', $id);
				$hasil = $this->db->update('bpd_tbl_surat_keluar', $data);
