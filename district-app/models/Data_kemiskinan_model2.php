...
class Data_kemiskinan_model extends MY_Model {
	...
	{
		// Penduduk yang sudah terdata untuk data_kemiskinan ini
	...
	{
		// Keluarga yang sudah terdata untuk data_kemiskinan ini
	...
	private function get_kk_terdata($data_kemiskinan_id, $p)
	{
		...
		$select_sql = "SELECT s.*, s.id_terdata, o.no_kk, s.id_data_kemiskinan, o.nik_kepala, o.alamat, q.nik, q.nama, q.tempatlahir, q.tanggallahir, q.sex, w.rt, w.rw, w.dusun ";
		$sql = $select_sql.$get_terdata_sql;
	...
	*/
	public function get_data_kemiskinan_detail_by_id($id)
	{
