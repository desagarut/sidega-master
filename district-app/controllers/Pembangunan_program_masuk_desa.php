...
class Pembangunan_program_masuk_desa extends Admin_Controller
{
	public function __construct()
	{
		...
		$this->load->model('pembangunan_program_masuk_desa_model', 'model');
	...
	public function index()
	{
		...
		$this->render('pembangunan/program_masuk_desa/index', [
	...
	public function daftar($id = 0, $aksi = '')
	{
		...
		$data['isi']            = "pembangunan/program_masuk_desa/cetak";
	...
	public function detail_program($id = 0)
	{
		...
		$this->render('pembangunan/program_masuk_desa/detail_program', $data);
	}
}
