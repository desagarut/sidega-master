...
define("LOKASI_SURAT_DESA", 'instansi/template-surat/');
define("LOKASI_SURAT_FORM_DESA", 'instansi/template-surat/form/');
define("LOKASI_SURAT_PRINT_DESA", 'instansi/template-surat/print/');
define("LOKASI_SURAT_EXPORT_DESA", 'instansi/template-surat/export/');
...

{
...

	{
...

		{
			...
			include(FCPATH . 'district-app/views/errors/html/error_404.php');
