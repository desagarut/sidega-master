...
| Untuk mengubah letakkan setting yang diinginkan di instansi/config/config.php
|--------------------------------------------------------------------------
*/
// Ambil setting SID khusus
define('LOKASI_SID_INI', 'instansi/config/');
...
// Untuk situs yang digunakan untuk demo, seperti https://sidega.desagarut.id,
