				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<?php if ($individu): ?>
								<?php include("sidega-app/views/surat/form/konfirmasi_pemohon.php"); ?>
							<?php	endif; ?>
							...
							<?php include("sidega-app/views/surat/form/nomor_surat.php"); ?>
							<div class="form-group">
							...
							<?php include("sidega-app/views/surat/form/tgl_berlaku.php"); ?>
							<?php include("sidega-app/views/surat/form/_pamong.php"); ?>
						</form>
					</div>
					<?php include("sidega-app/views/surat/form/tombol_cetak.php"); ?>
				</div>
			</div>
		</div>
	</section>
