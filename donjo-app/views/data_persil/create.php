							...
							<div class="col-sm-12">
								...
								<form name='mainform' action="<?= site_url('letterc/simpan_letterc') ?>" method="POST" id="validasi" class="form-horizontal">
									<div class="box-body">
										...
										<!-- Lampiran Dokumen-->
										<div class="form-group">
											<label class="control-label col-sm-3" for="dokumen">Unggah Dokumen</label>
											<div class="col-sm-8">
												<div class="input-group input-group-sm">
													<input type="text" class="form-control <?php empty($letterc["dokumen"]) and print('required') ?>" id="file_path" name="satuan">
													<input id="file" type="file" class="hidden" name="dokumen">
