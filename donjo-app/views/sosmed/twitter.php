	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea id="link" name="link" class="form-control input-sm" placeholder="Contoh : https://twitter.com/desagarut

Isi kolom ini dengan akun : desagarut" style="height: 200px; resize: none;"><?php if ($main): ?><?=$main['link'];?><?php endif; ?></textarea>
				</div>
			</div>
			<div class="form-group">
