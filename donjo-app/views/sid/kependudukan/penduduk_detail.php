      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-header">  <?php if ($this->CI->cek_hak_akses('h')): ?>
                  ...
                  <div class="tab-content">
                          ...
                          <div class="timeline-item"> <span class="time"><i class="fa fa-clock-o"></i> -</span>
                            ...
                            <div class="timeline-body">
                              ...
                              <div class="timeline-footer" align="right"> 
                                  <a href="<?= site_url("penduduk/rumah/$penduduk[id]")?>" class="btn bg-maroon btn-social btn-box	btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Hapus Rumah" ><i class="fa fa-trash-o"></i>Hapus Rumah</a> 
                    ...
                    <div class="active tab-pane" id="resume"> 
                      ...
                      <ul class="timeline timeline-inverse">
                        ...
                        <li><i class="fa fa-dollar bg-blue"></i>
                          <div class="timeline-item"> <span class="time"><a class="btn btn-primary btn-xs" href="<?=site_url()?>program_bantuan"><i class="fa fa-list"></i> Daftar Program Bantuan</a></span>
                            <h3 class="timeline-header"><a href="#bantuan">Program Bantuan</a></h3>
                            <div class="timeline-body">
                              <table class="table table-bordered table-striped table-hover detail">
                                <tr>
                                  <th class="padat">No</th>
