														...
														<tbody>
															<?php foreach ($main as $data): ?>
																<tr>
																	<td><?= $data['no']?></td>
																	<td nowrap>
																		<a href="<?= site_url("sid_core/sub_rt/$id_dusun/$data[id]")?>" class="btn bg-purple btn-box btn-sm" title="Rincian Sub Wilayah RW"><i class="fa fa-list"></i></a>
																		...
																		<?php if ($data['rw']!="-"): ?>
																			<div class="btn-group">
																				...
																				<ul class="dropdown-menu" role="menu">
																					<li>
																						<a href="<?= site_url("sid_core/ajax_kantor_rw_maps/$id_dusun/$data[id]")?>" class="btn btn-social btn-box btn-block btn-sm"><i class='fa fa-map-marker'></i> Lokasi Kantor RW</a>
																					</li>
																					<li>
																						<a href="<?= site_url("sid_core/ajax_wilayah_rw_maps/$id_dusun/$data[id]")?>" class="btn btn-social btn-box btn-block btn-sm"><i class='fa fa-map-marker'></i> Peta Wilayah RW</a>
																					</li>
																				</ul>
																			</div>
																		<?php endif; ?>
