													...
													<table class="table table-bordered table-striped dataTable table-hover">
														...
														<tbody>
															...
															<tr>
																...
																<td nowrap>
																	<a href="<?= site_url("sid_core/sub_rw/$data[id]")?>" class="btn bg-purple btn-box btn-sm" title="Rincian Sub Wilayah"><i class="fa fa-list"></i></a>
																	<?php if ($this->CI->cek_hak_akses('h')): ?>
																	...
																	<?php endif; ?>
																	<div class="btn-group">
																		<button type="button" class="btn btn-social btn-box btn-info btn-sm" data-toggle="dropdown"><i class='fa fa-arrow-circle-down'></i> Peta</button>
																		<ul class="dropdown-menu" role="menu">
																			<li>
																				<a href="<?= site_url("sid_core/ajax_kantor_dusun_maps/$data[id]")?>" class="btn btn-social btn-box btn-block btn-sm"><i class='fa fa-map-marker'></i> Lokasi Kantor <?=ucwords($this->setting->sebutan_dusun)?></a>
																			</li>
																			<li>
																				<a href="<?= site_url("sid_core/ajax_wilayah_dusun_maps/$data[id]")?>" class="btn btn-social btn-box btn-block btn-sm"><i class='fa fa-map-marker'></i> Peta Wilayah <?=ucwords($this->setting->sebutan_dusun)?></a>
																			</li>
																		</ul>
																	</div>
																</td>
