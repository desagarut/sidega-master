...
<div class="content-wrapper"> 
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h5>Detail Kerjasama Pihak Ketiga</h5>
        </div>
        <div class="col-sm-6">
              ...
              <div class="box-body">
                <table class="table table-hover">
                  ...
                  <tr>
                    ...
                    <td width="20px">:</td>
                    <td><?= $musdus->volume ?> <?= $musdus->satuan ?></td>
                  </tr>
                  <tr>
                    <th>Penerima manfaat</th>
                    <td width="20px">:</td>
                    <td>Laki-laki: <?= $musdus->laki ?> jiwa | Perempuan: <?= $musdus->satuan ?> jiwa | Rumah Tangga: <?= $musdus->rtm ?> jiwa</td>
                  </tr>
                  <tr>
                    <th>Perkiraan Biaya yang ditanggung Desa</th>
                    <td width="20px">:</td>
                    <td>Jumlah : Rp. <?= number_format($musdus->anggaran, 0) ?> | Sumber : <?= $musdus->sumber_dana ?></td>
                  </tr>
                  <tr>
                    <th>Perkiraan Biaya yang ditanggung Pihak Ketiga</th>
                    <td width="20px">:</td>
                    <td>Jumlah : Rp. <?= number_format($musdus->anggaran_pihak_ketiga, 0) ?> | Nama Pihak Ketiga : <?= $musdus->nama_pihak_ketiga ?></td>
                  </tr>
                  <tr>
