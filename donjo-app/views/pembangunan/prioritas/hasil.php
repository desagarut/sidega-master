				...
				},
				{
					'data': function(data) {
						...
						if (data.status_vote == 1) {
							status_vote = `<a href="<?= site_url('pembangunan_polling/tanggapan/') ?>${data.id}" id="status_vote" class="btn btn-icon btn-primary btn-sm mb-2 mr-2" title="Penentuan Prioritas Aktif">Lihat Detail</a>`
						} else {
