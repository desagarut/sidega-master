...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Pengelolaan SPPT <?= ucwords($this->setting->sebutan_desa)?> <?= $desa["nama_desa"];?></h1>
		<ol class="breadcrumb">
					...
					<div class="box box-info">
						<div class="box-header">
                            <div class="box-header with-border">
                                <a href="<?=site_url("data_sppt/sppt_form/")?>" class="btn btn-social btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Data SPPT">
                                    <i class="fa fa-plus"></i>Tambah SPPT
                                </a>
                                <a href="<?=site_url("data_sppt/cetak")?>" class="btn btn-social bg-blue btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Cetak Data" target="_blank">
                                    <i class="fa fa-print"></i> Cetak
                                </a>
                                <!--<a href="<?=site_url("data_sppt/unduh")?>" class="btn btn-social bg-navy btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data SPPT" title="Unduh Data SPPT">
                                    <i class="fa fa-download"></i>Unduh
                                </a>-->
                                <a href="<?= site_url('data_sppt/import')?>" class="btn btn-social bg-teal btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data SPPT" title="Unduh Data SPPT">
																	...
																	<table class="table table-bordered table-striped dataTable table-hover table-responsive">
																		<thead class="bg-purple">
																			<tr>
																				...
																				<th class="text-center"  width="14%">Pilih Aksi</th>
																		...
																		<tbody>
																			<?php foreach ($data_sppt as $item): ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center">
                                                                                    <div class="btn-group">
                                                                                      <button type="button" href="<?= site_url("data_sppt/sppt_detail/".$item["id_sppt"])?>" class="btn btn-info btn-box btn-sm" title="Detail Info Pajak" >Detail</button>
                                                                                      <button type="button" class="btn btn-warning btn-sm dropdown-toggle" data-toggle="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu" role="menu">
                                                                                            ...
                                                                                            <li><a href="#" data-href="<?= site_url("data_sppt/hapus/".$item["id_tagih"])?>" class="btn btn-social bg-red btn-box btn-block btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i> Hapus</a></li>
                                                                                        </ul>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td><?= $item['letak_op'] ?></td>
                                                                                    <td><?= strtoupper($item["namatertagih"]) ?></br>
                                                                                    	<i style="color:#090">NIK : </i><i><a href='<?= site_url("penduduk/detail/1/0/$item[id_pend]")?>'><?= $item["nik"] ?></a></i></td>
                                                                                    <td><?= $item['alamat'] ?></td>
                                                                                </tr>
																				<?php endforeach; ?>
                                                                        </tbody>
