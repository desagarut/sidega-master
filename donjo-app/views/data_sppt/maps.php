...
<form action="<?= $form_action?>" method="post" id="validasi">
	...
	<div class="modal-footer">
        <div class='col-xs-12'>
            ...
            <a href="#" class="btn btn-social btn-box btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" download="OpenSID.gpx" id="exportGPX"><i class='fa fa-download'></i> Export ke GPX</a>
