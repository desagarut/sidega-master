					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="nik_rekanan" id="nik_rekanan" value="<?= $rekanan['nik_rekanan'] ?>" type="text" placeholder="NIK Rekanan" />
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="jenis_usaha" id="jenis_usaha" value="<?= $rekanan['jenis_usaha'] ?>" type="text" placeholder="Jenis Usaha" />
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="no_rek" id="no_rek" value="<?= $rekanan['no_rek'] ?>" type="text" placeholder="No. Rekening" />
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="telepon" id="telepon" value="<?= $rekanan['telepon'] ?>" type="text" placeholder="Nomor Telepon" />
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-3 control-label" style="text-align:left;">Email</label>
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="email" id="email" value="<?= $rekanan['email'] ?>" type="text" placeholder="Email" />
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-3 control-label" style="text-align:left;">Alamat</label>
								<div class="col-sm-9">
									<input class="form-control input-sm required" name="alamat" id="alamat" value="<?= $rekanan['alamat'] ?>" type="text" placeholder="Alamat Lengkap" />
								</div>
							</div>
