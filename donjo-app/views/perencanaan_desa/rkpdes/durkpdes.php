              ...
              <div class="col-md-12">
                <div class="box-header">
                  <div class="col-md-12">
                    <div class="row"> 
						<div class="col-md-1">
						<a href="<?= site_url("perencanaan_desa/dialog_cetak_durkpdes/{$perencanaan_desa->id}/cetak")?>" class="btn bg-purple btn-sm" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Data DU-RKP Desa" title="Cetak Data DU-RKP Desa"><i class="fa fa-print "></i> Cetak</a>&nbsp;
						</div>
...
<script>
	$(document).ready(function() {
		$('#example1').DataTable({
			...
			'ajax': {
				'url': "<?= site_url('perencanaan_desa/durkpdes') ?>",
				'method': 'POST',
				'data': function(d) {
					d.tahun = $('#tahun').val();
				}
				...
				},
				{
					'data': function(data) {
						...
						if (data.status_usulan_musrenbang_kecamatan == 1) {
							status_usulan_musrenbang_kecamatan = `<a href="<?= site_url('perencanaan_desa/usulan_kecamatan_non_aktiv/') ?>${data.id}" class="btn btn-icon btn-success disabled" title="Usulan Musrenbang Kecamatan Aktif">Diusulkan <br/>Ke Musrenbang <br/>Tingkat Kecamatan</a>`
						} else {
							status_usulan_musrenbang_kecamatan = `<a href="<?= site_url('perencanaan_desa/usulan_kecamatan_aktiv/') ?>${data.id}" class="btn btn-icon btn-warning disabled" title="Belum di Proses Usulan Musrenbang Kecamatan">Belum di Proses Usulan Musrenbang Kecamatan</a>`
						}
						return `
