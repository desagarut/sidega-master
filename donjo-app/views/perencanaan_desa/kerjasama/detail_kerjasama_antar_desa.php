...
<div class="content-wrapper"> 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="<?= site_url() ?>perencanaan_desa/kerjasama_pihak_ketiga">Kerjasama Antar Desa</a></li>
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="box">
        <div class="box-header"> <a href="<?= site_url() ?>perencanaan_desa/kerjasama_antar_desa" class="btn btn-sm btn-info">Kembali</a> <span class="text-right">
          <h5>DETAIL KERJASAMA ANTAR DESA</h5>
          </span> </div>
      </div>
