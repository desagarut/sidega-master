				...
				},
				{
					'data': function(data) {
						...
						<ul class="dropdown-menu" role="menu">
								<li><a href="<?= site_url('perencanaan_desa/vote/'); ?>${data.id}">Daftarkan Ke Penentuan Prioritas Desa</a></li>
								<li><a href="<?= site_url('perencanaan_desa/unvote/'); ?>${data.id}">Tutup Penentuan Prioritas Desa</a></li>
							</ul>
						</div><br/>
