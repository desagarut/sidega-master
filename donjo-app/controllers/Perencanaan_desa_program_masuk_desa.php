...
class Perencanaan_desa_program_masuk_desa extends Admin_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Perencanaan_desa_program_masuk_desa_model', 'model');
	...
	public function index()
	{
		...
		$this->render('perencanaan_desa/program_masuk_desa/index', [
	...
	{
		$this->model->insert();
		redirect('perencanaan_desa_program_masuk_desa');
	}
	...
	public function dialog_daftar($id = 0, $aksi = '')
	{
		$this->load->view('global/ttd_pamong', [
			...
			'form_action' => site_url("perencanaan_desa_program_masuk_desa/daftar/$id/$aksi"),
		]);
	}
	...
	public function daftar($id = 0, $aksi = '')
	{
		...
		$data['isi']            = "perencanaan_desa/program_masuk_desa/cetak";
	...
	public function detail_program($id = 0)
	{
		...
		$this->render('perencanaan_desa/program_masuk_desa/detail_program', $data);
	}
}
