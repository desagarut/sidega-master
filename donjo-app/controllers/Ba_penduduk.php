...
class Ba_penduduk extends Admin_Controller {
	...
	public function tables($page="induk", $page_number=1, $offset=0)
	{
		...
		$this->load->view('nav');
		$this->load->view('ba/penduduk/main', $data);
	...
	{
		$data['main_content'] = "ba/penduduk/content_induk";
	...
	{
		$data['main_content'] = "ba/penduduk/content_mutasi";
	...
	{
		$data['main_content'] = "ba/penduduk/content_rekapitulasi";
	...
	{
		$data['main_content'] = "ba/penduduk/content_sementara";
	...
	{
		$data['main_content'] = "ba/penduduk/content_ktp_kk";
