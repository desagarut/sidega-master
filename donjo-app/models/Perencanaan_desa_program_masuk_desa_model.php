...
class Perencanaan_desa_program_masuk_desa_model extends CI_Model
{
	protected $table = 'tbl_perencanaan_desa_program_masuk_desa';
	...
	public function insert()
	{
		...
		$outp = $this->db->insert('tbl_perencanaan_desa_program_masuk_desa', $data);
	...
	public function update($id = 0)
	{
		...
		$this->db->where('id', $id);
		$outp = $this->db->update('tbl_perencanaan_desa_program_masuk_desa', $data);
