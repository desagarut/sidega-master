...
class Perencanaan_desa_dok_model extends CI_Model
{
	...
	public function insert($id_perencanaan_desa = 0)
	{
		...
		$outp = $this->db->insert('tbl_perencanaan_desa_dok', $data);
	...
	public function update($id = 0, $id_perencanaan_desa = 0)
	{
		...
		$this->db->where('id', $id);
		$outp = $this->db->update('tbl_perencanaan_desa_dok', $data);
	...
	public function find_dokumentasi($id_perencanaan_desa)
	{
