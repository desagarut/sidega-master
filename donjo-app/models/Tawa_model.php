<?php class Tawa_model extends MY_Model {
	...
	public function insert()
	{
	  ...
	  $tipe_file = TipeFile($_FILES['gambar']);
		...
		$data['trayek']         				= $this->input->post('trayek');
	...
	public function insert_layanan($parrent=0)
	{
	  ...
	  $tipe_file = TipeFile($_FILES['gambar']);
		...
		$data['nama_pengendara'] = $this->input->post('nama_pengendara'); 
		...
		$data['tahun_pembuatan'] = $this->input->post('tahun_pembuatan');
		$data['warna_kendaraan'] = $this->input->post('warna_kendaraan'); 
		$data['warna_plat_nomor'] = $this->input->post('warna_plat_nomor'); 
		$data['bahan_bakar'] = $this->input->post('bahan_bakar'); 
		$data['isi_silinder'] = $this->input->post('isi_silinder'); 
