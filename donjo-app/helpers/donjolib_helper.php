...
function insidega_timer()
{
	$time = 300;  //300 detik
	$_SESSION['insidega_try'] = 4;
	$_SESSION['insidega_timeout'] = time() + $time;
}

function insidega_timeout()
{
	$timeout = (isset($_SESSION['insidega_timeout'])) ? $_SESSION['insidega_timeout'] : null;
	if (time() > $timeout)
	{
		$_SESSION['insidega_wait'] = 0;
	}
}
