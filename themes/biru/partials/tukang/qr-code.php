...
<section id="features" class="features" >
  ...
  <div class="col-lg-12 col-md-4 mt-0">
    <h2><i class="ri-store-2-fill" style="color:#e80368;"></i> UMKM <strong style="color:#C00">TUKANG</strong></h2>
    <img src="<?= base_url("$this->theme_folder/$this->theme/assets/img/tukang.png" ) ?>" class="img-fluid" alt="<?= $album['nama'] ?>"> </div>
