      ...
      <div class="col-md-8">
        <div class="portfolio-details-container" data-aos="fade-right" data-aos-delay="300">
          <div class="owl-carousel portfolio-details-carousel">
            ...
            <div class="portfolio-description"> <a class="archive__link" href="<?= site_url('first/produk_show/'.$data['id']) ?>"> <img src="<?= AmbilGaleri($data['gambar'],'kecil') ?>" class="img-fluid" alt="<?= $data['nama'] ?>"> </a>
  ...
  <div class="col-lg-3 col-md-6 align-items-stretch owl-carousel portfolio-details-carousel">
    <div class="member" data-aos="fade-up">
      ...
      <div class="member-info">
        <h4 style="color:#C00">
          <a class="archive__link" href="<?= site_url('first/produk_show/'.$data['id']) ?>"><?= $data['nama'] ?></a>
        </h4>
