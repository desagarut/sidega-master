    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Portal Desa</h2>
          <p>Kenali <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($desa['nama_desa']) ?> lebih dekat</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h3><a href="">Layanan Mandiri</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-road-map-fill" style="color: #47aeff;"></i>
              <h3><a href="">Peta Desa</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              ...
              <h3><a href="<?= site_url('first/arsip') ?>">Berita Desa</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
