...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title"><a href="<?= site_url("arsip")?>"><i class="fa fa-archive"></i> Arsip Artikel</a></h3>
	</div>
	<div id="arsip_artikel" class="card-body">
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active" aria-current="page" href="#terkini">Terkini</a></li>
			<li class="nav-item"><a class="nav-link" href="#populer">Populer</a></li>
			<li class="nav-item"><a class="nav-link" href="#acak">Acak</a></li>
		</ul>
