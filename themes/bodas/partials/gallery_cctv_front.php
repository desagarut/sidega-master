...
<div class="container-xxl py-5">
  <div class="container">
    <div class="text-center wow fadeInUp" data-wow-delay="0.2s">
      <h1 class="mb-5">CCTV <a href="<?= site_url("first/gallery_cctv/{$data['id']}") ?>" class="flex-shrink-0 btn btn-sm btn-warning px-3" style="border-radius: 8px 8px 8px 8px;"><i class="fa fa-eye"></i></a></h1>
    </div>
          ...
          <div class="col-md-12 wow fadeInUp testimonial-item text-center" data-wow-delay="0.1s">
            <div class="team-item bg-light">
              ...
              <div class="text-center p-4">
                <h6 class="mb-0"><a href="<?= site_url("first/gallery_cctv/{$data['id']}") ?>"><?= strtoupper($data['nama']) ?></a></h6>
              </div>
            </div>
          </div>
        <?php endif; ?>
