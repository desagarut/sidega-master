                            ...
                            <div class="course-item bg-light">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                        <a href="<?= site_url('first/produk_show/' . $data['id']) ?>" class="flex-shrink-0 btn btn-sm btn-info px-3 border-end" style="border-radius: 30px 0 0 30px;">Lihat</a>
                                ...
                                <div class="text-center p-4 pb-0">
                                    <h5 class="mb-0"><a href="<?= site_url('first/produk_show/' . $data['id']) ?>"><?= $data['nama'] ?></a></h5><br />
                                    <h6 class="mb-4"><i class="fa fa-map-marker-alt text-danger"></i> <?= $data['lokasi'] ?></h6>
                                    <div class="text-start">
                                        <small>Kategori : <?= $data['kategori_toko'] ?></small><br />
                                        <small>Produk Unggulan : <?= $data['produk_utama'] ?></small>
                                    </div>
                                </div>
