            ...
            <div class="wow fadeInUp testimonial-item text-center shadow" data-wow-delay="0.1s">
                <a href="https://siskeudes-garutkab.simdacloud.id/" target="_blank">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                        <img src="https://garutkab.smartvillage.info/assets/img/siskeudes.svg" class="p-0 mx-auto mb-0" style="width: 150px; height: 100px;"><br>
                            <h5 class="mb-1"> Sistem Informasi Keuangan Desa</h5>
                        </div>
                    </div>
                </a>
            </div>
