                            ...
                            <div class="course-item bg-light">
                                ...
                                <div class="text-center p-4 pb-0">
                                    ...
                                    <div class="text-start">
                                        ...
                                        <small>Layanan : <?= $data['jenis_layanan'] ?></small><br/>
                                        <small>Area : <?= $data['area'] ?></small><br/>
                                        <small>Kelompok : <?= $data['kelompok_usaha'] ?></small><br/>
                                        <small>Lokasi : <?= $data['lokasi'] ?></small>
                                    </div>
                                </div>
