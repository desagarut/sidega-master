...
<div class="single-product">
	<div class="single_page_area">
		<h3 class="post_titile" >Data Demografi Berdasar <?=$heading?></h3>
	</div>
...
<div class="box-header with-border">
	<h4 class="post_titile">Tabel <?= $heading ?></h4>
</div>
<div class="box-body">
	<div class="table-responsive">
		<table class="table table-striped">
			<thead>
				...
				<tr>
					<th style='text-align:center'>n</th><th style='text-align:right'>%</th>
					<?php if ($jenis_laporan == 'penduduk'):?>
			...
			<tbody>
				...
				<?php foreach ($stat as $data):?>
					<?php $jm1++; if (1):?>
						...
						<?php endif;?>
						<tr class="<?=$hide?>">
							<td class="angka" style='text-align:center;'>
								<?php if ($jm1 > $jm - 2):?>
									<?=$data['no']?>
								<?php else:?>
									<?=$h?>
							...
							<td><?=$data['nama']?></td>
							<td class="angka" style='text-align:center;' <?php ($jm1 <= $jm - 2) and ($data['jumlah'] == 0) and print('nol')?>"><?=$data['jumlah']?></td>
