            ...
            <div class="hero-small-banner style2">
              <div class="content">
                ...
                <p class="text-left"><strong>adalah </strong> wadah bagi masyarakat <strong>
                  <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($desa['nama_desa']) ?></strong>, yang bertujuan untuk fasilitasi seluruh aktivitas warga, baik warga desa atau pendatang yang ingin melakukan perjalanan baik di dalam
                  maupun ke luar wilayah <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($desa['nama_desa']) ?></strong>.</p>
              </div>
            </div>
            <!-- Start Small Banner --> 
          </div>
