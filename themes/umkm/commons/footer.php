      ...
      <div class="inner-content">
        <div class="row">
          <div class="col-lg-3 col-md-4 col-12">
            <div class="footer-logo"> <a href="<?= site_url('first') ?>"> <img src="<?= gambar_desa($desa['logo']) ?>" style="padding-bottom: 5px; width:38px;" alt="Logo"> </a>&nbsp; <a href="<?= site_url('first') ?>" style="color:white; text-shadow: 2px 1px 2px #000; -webkit-text-stroke: 1px transparent; font-size: 25px; font-weight: normally; text-transform: normally; font-family: candara">
              <?= ucfirst($this->setting->sebutan_desa) . ' ' . ucwords($desa['nama_desa']) ?>
              </a> </div>
          </div>
          <div class="col-lg-9 col-md-8 col-12">
            <div class="footer-newsletter">
              <h4 class="title"> Subscribe to our Newsletter <span>Get all the latest information, Sales and Offers.</span> </h4>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12"> 
            ...
            <div class="single-footer f-contact">
              ...
              <p class="mail">Email: <a href="mailto:<?= $desa['email_desa']; ?>">
                <?= $desa['email_desa']; ?>
                </a> </p>
              <p>Alamat:<br />
                <?= $desa['alamat_kantor']; ?>
          ...
          <div class="col-lg-3 col-md-6 col-12"> 
            ...
            <div class="single-footer our-app">
              ...
              <ul class="app-btn">
                <li> <a href="javascript:void(0)"> <i class="lni lni-apple"></i> <span class="small-title">Download on the</span> <span class="big-title">App Store</span> </a> </li>
                <li> <a href="javascript:void(0)"> <i class="lni lni-play-store"></i> <span class="small-title">Download on the</span> <span class="big-title">Google Play</span> </a> </li>
              </ul>
            </div>
            <!-- End Single Widget --> 
          </div>
      ...
      <div class="inner-content">
        <div class="row align-items-center">
          <div class="col-lg-4 col-12">
            <div class="payment-gateway"> <span>Our Partner:</span> <img src="" alt="#"> </div>
          </div>
          <div class="col-lg-4 col-12">
            <div class="copyright">
              <p><strong><a href="https://desagarut.net" target="_blank">
                <?= $this->setting->website_title ?>
                <?= AmbilVersi() ?>
                | Tema
                <?= $this->setting->web_theme ?>
                <?= THEME_VERSION ?>
                </a> </strong> 
            </div>
            <div class="copyright">
              ...
              Kabupaten Garut &copy;
              <?= date('Y') ?>
              <br />
              Diberdayakan Oleh
              <?= $this->setting->pemberdaya ?>
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-12">
            <ul class="socila">
              ...
              <li> <a href="<?= $data['link']?>" target="_blank" alt="<?= $data['nama'] ?>"><i class="lni lni-<?= $data['nama'] ?>"></i></a> </li>
              <?php endif; ?>
              <?php endforeach; ?>
            </ul>
          </div>
