...
<script src="<?= base_url("$this->theme_folder/$this->theme/assets/vendor/counterup/counterup.min.js")?>"></script>
...
<script src="<?= base_url("$this->theme_folder/$this->theme/assets/vendor/glightbox/css/glightbox.min.js")?>"></script>
<!-- Vendor JS Files -->
