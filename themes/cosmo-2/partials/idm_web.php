	...
	.highcharts-data-table tr:hover {
		...
		<div class="panel panel-info">
			<div class="panel-header">
                <h1>Status IDM <?= ucwords($this->setting->sebutan_desa).' '.ucwords($desa['nama_desa'])?> </h1>
            </div>
			<div class="box-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kiri">
								<div class="small-box" style="background-color:#CF0">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kiri">
								<div class="small-box" style="background-color:#0F9">
									<div class="inner" align="center">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kiri status-idm-kanan">
								<div class="small-box" style="background-color:#FF3">
									<div class="inner" align="center">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kanan">
								<div class="small-box" style="background-color:#9F0">
									<div class="inner" align="center">
											...
											<table class="table table-bordered table-striped dataTable table-hover">
												<tbody>
													<tr>
                                                            ...
                                                            <tr>
																<th class="horizontal">KODE DESA</th>
																<td> : <?= $idm->IDENTITAS[0]->id_desa ?></td>
															</tr>
                                                            <tr>
