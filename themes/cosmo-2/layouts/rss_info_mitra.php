...
<body>
	...
	<section class="main-wrapper">
		<main class="content">
			<div class="--mb-10">
				<?php // $this->load->view($folder_themes . '/partials/desa/feed1') ?>
				<?php $this->load->view($folder_themes . '/partials/desa/feed2') ?>
				<?php $this->load->view($folder_themes . '/partials/desa/feed3') ?>
			</div>
