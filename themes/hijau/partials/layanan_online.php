...
<?php
	...
	if( ! isset($_SESSION['mandiri']) OR $_SESSION['mandiri']<>1) {
		...
		if($_SESSION['mandiri_wait'] == 1) { ?>
                ...
                <h3 class="sidebar-title">Layanan <?= ucwords($this->setting->sebutan_desa . " " . $desa['nama_desa']); ?></h3>
	...
	?>
				...
				<h3 class="sidebar-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $desa['nama_desa']); ?></h3>
		...
		<?php if(isset($_SESSION['lg']) AND $_SESSION['lg'] == 1) { ?>
					...
					<h5 class="sidebar-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $desa['nama_desa']); ?></h5><br />
		...
		<?php } else if(isset($_SESSION['lg']) AND $_SESSION['lg'] == 2) { ?>
					...
					<h3 class="box-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $desa['nama_desa']); ?></h3><br />
