...
<div class="box box-primary box-solid">
	<div class="box-header">
		<h3 class="sidebar-title"><i class="fa fa-bar-chart-o"></i> Statistik Pengunjung</h3>
	</div>
	<div class="box-body">
		<?php
		...
		<div align="center"><small>
			<table cellpadding="0" cellspacing="0" class="counter col-md-12 tabel table-hover">
				<tr>
					<td> Hari ini</td>
					<td align="right"><?= num_toimage($today, $total); ?></td>
				</tr>
				<tr>
					<td valign="middle" height="20">Kemarin </td>
					<td valign="middle" align="right"><?= num_toimage($yesterday, $total); ?></td>
				</tr>
				<tr>
					<td valign="middle" height="20">Jumlah pengunjung</td>
					<td valign="middle" align="right"><?= num_toimage($total, $total); ?></td>
				</tr>
			</table></small>
		</div>
	</div>
