...
<page orientation="portrait" format="215x330" style="font-size: 7pt">
	...
	<table class="disdukcapil" style="margin-top: 0px;">
		...
		<tr>
			...
			<td>:</td>
			<td colspan="23" class="kotak"><?= $individu['alamat'].ucwords(strtolower($this->setting->sebutan_wilayah))." ".ucwords(strtolower($individu['dusun']))?></td>
		...
		<tr>
			...
			<td colspan="12" class="kotak"><?= $config['nama_deskel'];?></td>
